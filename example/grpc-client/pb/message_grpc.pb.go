...
type ConverterClient interface {
	...
	PythonAST(ctx context.Context, in *ConvertRequest, opts ...grpc.CallOption) (*ConvertReply, error)
}
...
func (c *converterClient) PythonAST(ctx context.Context, in *ConvertRequest, opts ...grpc.CallOption) (*ConvertReply, error) {
	out := new(ConvertReply)
	err := c.cc.Invoke(ctx, "/pb.Converter/PythonAST", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConverterServer interface {
	// Sends a Converter request
	PythonAST(context.Context, *ConvertRequest) (*ConvertReply, error)
...
func (UnimplementedConverterServer) PythonAST(context.Context, *ConvertRequest) (*ConvertReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PythonAST not implemented")
}
...
func _Converter_PythonAST_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConvertRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConverterServer).PythonAST(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Converter/PythonAST",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConverterServer).PythonAST(ctx, req.(*ConvertRequest))
	}
...
var Converter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PythonAST",
			Handler:    _Converter_PythonAST_Handler,
		},
	},
